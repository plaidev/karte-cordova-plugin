...
exports.identifyWithUserId = function(userId, values, success, error) {
    return run(function(success, error) {
        exec(success, error, Constants.PLUGIN_NAME, "identifyWithUserId", [userId, values]);
    }, success, error);
}

exports.attribute = function(values, success, error) {
    return run(function(success, error) {
        exec(success, error, Constants.PLUGIN_NAME, "attribute", [values]);
    }, success, error);
}
